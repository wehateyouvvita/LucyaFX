...
def create_account(username, password, email, gender, birthday):
    ...
    cursor.execute('INSERT INTO accounts VALUES (NULL, %s, %s, %s, %s, %s, %s, %s, %s, NULL, %s, %s)', (username, hashedpassword.hexdigest(), email, 0, 15, "Yeah...", 0, 0, gendertype, str(birthday)))
