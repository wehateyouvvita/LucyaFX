...
app.config['MYSQL_HOST'] = '127.0.0.1' # mysql hostname ex: localhost or 293.423.562.52
app.config['MYSQL_USER'] = 'lucya23user' # mysql login username
app.config['MYSQL_PASSWORD'] = 'twikipedia08' # mysql login password
app.config['MYSQL_DB'] = 'lucya23user' # mysql database where its supposed be the tables you inserted before.
